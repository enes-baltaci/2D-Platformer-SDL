...
#define	PLAYER_WALK1 (5)
#define	PLAYER_WALK2 (6)
#define	PLAYER_WALK3 (7)
#define PLATFORM2_ENTITY_ID (3)
#define GAMEOVER (4)
#define GROUNDED (630)
#define ISPRESSED (771)
...
{
	enum Program_State prg = running;
	...
	while (entitiees[PLAYER_ENTITY_ID].getMid().y != 558)
	{
		...
		entitiees[PLAYER_WALK1].setPos(entitiees[PLAYER_WALK1].getPos().x, entitiees[PLAYER_WALK1].getPos().y + 1);
		entitiees[PLAYER_WALK2].setPos(entitiees[PLAYER_WALK2].getPos().x, entitiees[PLAYER_WALK2].getPos().y + 1);
		entitiees[PLAYER_WALK3].setPos(entitiees[PLAYER_WALK3].getPos().x, entitiees[PLAYER_WALK3].getPos().y + 1);
	}
	...
	while (gameRunning)
	{
		...
		if (!gameOver && mouse)
		{
			...
			{
				entitiees[PLAYER_ENTITY_ID].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y - 1);
				entitiees[PLAYER_WALK1].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y - 1);
				entitiees[PLAYER_WALK2].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y - 1);
				entitiees[PLAYER_WALK3].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y - 1);
			}
			else
			{
				entitiees[PLAYER_ENTITY_ID].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y + 1);
		...
		if (!gameOver)
		{
			if (!change[0])
			{
				entitiees[PLAYER_ENTITY_ID] = entitiees[PLAYER_WALK1];
				change[0] = 1;
			}
			else if (!change[1] && changeIndex == 100)
			{
				entitiees[PLAYER_ENTITY_ID] = entitiees[PLAYER_WALK2];
				change[1] = 1;
			}
			else if (changeIndex == 200)
			{
				entitiees[PLAYER_ENTITY_ID] = entitiees[PLAYER_WALK3];
			}
			...
			if (entitiees[PLAYER_ENTITY_ID].getMid().x < 620 && (entitiees[PLAYER_ENTITY_ID].getMid().x - mouseX < 150 && entitiees[PLAYER_ENTITY_ID].getMid().x - mouseX > 0 && mouseY - entitiees[PLAYER_ENTITY_ID].getPos().y < 200 && mouseY - entitiees[PLAYER_ENTITY_ID].getPos().y > 0))
			{
				...
				entitiees[PLAYER_WALK1].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y);
				entitiees[PLAYER_WALK2].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y);
				entitiees[PLAYER_WALK3].setPos(entitiees[PLAYER_ENTITY_ID].getPos().x, entitiees[PLAYER_ENTITY_ID].getPos().y);
			}
